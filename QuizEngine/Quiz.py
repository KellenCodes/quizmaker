...
class Quiz:
	def __init__(self, quiz_tuple, gui):
		
		self.gui = gui
		self.questions = quiz_tuple[0]
		self.options = quiz_tuple[1]
		self.answers = quiz_tuple[2]
	...
	def display_question(self):
		...
		q_no = Label(self.gui, text=self.questions[self.q_no], width=60,
	...
	def display_title(self):
		...
		title = Label(self.gui, text="GeeksforGeeks QUIZ",
